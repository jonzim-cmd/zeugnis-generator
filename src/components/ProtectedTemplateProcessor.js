// src/components/ProtectedTemplateProcessor.js
import React, { useState } from 'react';
import WordTemplateProcessor from './WordTemplateProcessor';

const ProtectedTemplateProcessor = (props) => {
  ...
  // Bei erfolgreicher Authentifizierung wird der WordTemplateProcessor gerendert
  return <WordTemplateProcessor {...props} />;
};

export default ProtectedTemplateProcessor;
